...
>
    ...
    {{-- Link overlay: sits behind content (z-0) so action buttons (z-10) intercept their own clicks --}}
    <a
        href="{{ $url }}"
    ...
    {{-- Visible content: z-10 ensures action buttons receive clicks before the link overlay --}}
